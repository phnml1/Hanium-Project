...
function LoginModal({ width, height, setIsModal, setData }) {
    ...
    <div className="fixed top-0 left-0 right-0 bottom-0 bg-gray-700 bg-opacity-50 z-50">
      ...
      >
        ...
        <div className="mt-8 w-full flex flex-col items-center">
          <div className="w-3/4 text-2xl font-bold text-blue-900 text-center">Log in</div>
        ...
        <div className="absolute bottom-8 w-full flex flex-col items-center text-center font-semibold text-lg">
          ...
          <div className='w-3/4 text-xs mt-2 font-normal text-gray-400 text-center'>
            You don't have an account yet? <span className='text-orange-600 cursor-pointer'>Sign in</span>
          </div>
        </div>
      </div>
    </div>
